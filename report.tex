...
% Chapter Title (16 pt, Bold, centered)
...
\vspace{1em}
\noindent\textbf{Keywords:} Video Streaming Platform, Machine Learning, Recommendation System, Artificial Intelligence, Content Creation Tools, User Experience, Collaborative Filtering, Web Application.
\clearpage
...
Driven by these challenges, Neptube aims to develop a web-based, localized video streaming platform that leverages cutting-edge machine learning techniques to deliver personalized recommendations and AI-powered creator tools~\cite{ref12}. This project is motivated by the vision to empower Nepali creators, enhance content discovery, and foster a vibrant, interactive community. Neptube aspires to bridge the gap between advanced technology and local cultural relevance, thereby enriching Nepal's digital entertainment ecosystem and offering a truly tailored viewing experience.
...
\begin{itemize}
    ...
    \item Low-bandwidth streaming options (from 144p to 1080p), ensuring accessibility in regions with internet speed challenges~\cite{ref9}~\cite{ref14}.
\end{itemize}
...
\begin{itemize}
    \item Netflix reports 80\% of its content views are driven by its recommendation system~\cite{ref17}~\cite{ref6}.
    \item Collaborative filtering and content-based filtering are widely used for tailoring content suggestions~\cite{ref1a}.
...
\begin{itemize}
    \item AI tools are used to generate thumbnails, video titles, and descriptions~\cite{ref10}.
    \item YouTube and other platforms employ AI to assist creators with trend-based suggestions~\cite{ref11}.
...
\begin{itemize}
    \item Most Nepali streaming services (e.g., NET TV, NepalFlix) lack ML-based recommendations~\cite{ref19}~\cite{ref18}.
...
\begin{table}[H]
    \centering
    \caption{Project Development Timeline (Gantt Chart) -- Full Year}
    \label{tab:gantt_chart}
    \renewcommand{\arraystretch}{1.2}
    \rowcolors{2}{white}{lightgray}
    \scriptsize
    \begin{tabular}{|p{0.15\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|>{\centering\arraybackslash}p{0.04\textwidth}|}
        \hline
        \rowcolor{tableheader}
        \textbf{Works} & \textbf{M1} & \textbf{M2} & \textbf{M3} & \textbf{M4} & \textbf{M5} & \textbf{M6} & \textbf{M7} & \textbf{M8} & \textbf{M9} & \textbf{M10} & \textbf{M11} & \textbf{M12} \\
        \hline
        Pre Analysis & \cellcolor{green!50}$\bullet$ & & & & & & & & & & & \\
        \hline
        Project Proposal & & \cellcolor{green!50}$\bullet$ & & & & & & & & & & \\
        \hline
        Detailed Study & & & \cellcolor{green!50}$\bullet$ & & & & & & & & & \\
        \hline
        Initial Prototype & & & & \cellcolor{green!50}$\bullet$ & \cellcolor{green!50}$\bullet$ & & & & & & & \\
        \hline
        Implementation 1 & & & & & & \cellcolor{green!50}$\bullet$ & & & & & & \\
        \hline
        Implementation 2 & & & & & & & \cellcolor{necblue!40}$\bullet$ & \cellcolor{necblue!40}$\bullet$ & & & & \\
        \hline
        ML Integration & & & & & & & & & \cellcolor{necblue!40}$\bullet$ & \cellcolor{necblue!40}$\bullet$ & & \\
        \hline
        Testing \& QA & & & & & & & & & & & \cellcolor{necblue!40}$\bullet$ & \\
        \hline
        Documentation & & & & & & & & & & & & \cellcolor{necblue!40}$\bullet$ \\
        \hline
    \end{tabular}
    
    \vspace{0.3cm}
    \small
    \textbf{Legend:} \colorbox{green!50}{Completed} \quad \colorbox{necblue!40}{Planned/In Progress}
\end{table}
